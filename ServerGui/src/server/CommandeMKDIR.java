...
public class CommandeMKDIR extends Commande {
	 ...
	 */
	public CommandeMKDIR(PrintStream ps, String commandeStr, InformationClient cl, CommandExecutor ce) { 
	...
	public void execute() {
		...
		if(!this.commandeArgs[0].isEmpty()) {
		        ...
		        if (nouveauRepertoire.exists()) {
		            ...
		            ps.println("2 mkdir : The folder '" + nomRepertoire + "' already exist");
		        }
		            ...
		            if(creationSucces) {
		            	...
		            	ps.println("2 mkdir : The folder '" + nomRepertoire + "' couldn't be created");
		            }
		        }
		}
		else {
